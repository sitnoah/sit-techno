...
def document(title,description,body):
 return '<!doctype html>\n<html lang="en-GB"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex,nofollow"><title>'+html.escape(title)+' | SIT Consultancy</title><meta name="description" content="'+html.escape(description,quote=True)+'"><meta name="theme-color" content="#f4d63b"><link rel="icon" href="/assets/sit-technology-icon.svg" type="image/svg+xml"><link rel="stylesheet" href="/assets/site.css?v=0.4.2"><link rel="stylesheet" href="/assets/redesign.css?v=0.4.2"><link rel="stylesheet" href="/assets/consultancy.css?v=0.4.2"><link rel="stylesheet" href="/assets/mobile.css?v=0.4.2"><script src="/assets/site.js?v=0.4.2" defer></script><script src="/assets/discovery.js?v=0.4.2" defer></script></head><body>'+resolve(header)+'<main id="main">'+resolve(body)+'</main>'+resolve(footer)+'</body></html>'
